...
export default function Footer({ isLoaded = true }: FooterProps) {
  return (
    <footer
      className={`w-full bg-red100/95 backdrop-blur-sm border-t border-gray-100 py-6 mt-12 transition-all duration-1200 ease-in-out ${
    ...
    >
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-6">
          ...
          >
            &ldquo;In the silence between heartbeats, I found a sky that remembers
            every dream we&rsquo;ve forgotten to chase.&rdquo;
          </blockquote>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="text-left">
            ...
            <p
              ...
              style={{ fontFamily: "'Cormorant Garamond', serif" }}
            >
              A wandering soul, collecting forgotten dreams and star-dusted tales. I find poetry in parking lots and philosophy in passing clouds, weaving stories from strangers, stars, and sleepless nights.
            </p>
          </div>
        </div>
        ...
        <div className="text-center">
          <p
            ...
            style={{ fontFamily: "'Inter', sans-serif" }}
          >
            © 2025 Bhabuk • From &ldquo;Uperhaps&rdquo; an unpublished collection
          </p>
        </div>
      </div>
    </footer>
