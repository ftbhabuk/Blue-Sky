      ...
      >
        <Section delay={0.2}>
          ...
          >
            ...
            <p>
              I’m uncertain, like a rose pale and dying, dropping its petals.
              This world before me… is unsure. I’m living too much inside of
              myself again.
            </p>
            <EnhancedMarginNote side="right">
              Living too much inside myself
            </EnhancedMarginNote>
            <EnhancedBlockQuote>
        ...
        <Section delay={0.4}>
          ...
          >
            <p>
              ...
              all right.” The room swims into focus, revealing some familiar
              faces, their expressions soaked in sorrow.
            </p>
            <p>
              I have no idea what’s going on. Where am I? Who are they? I feel
              incompetent. Lost. All at once. My mind feels foggy, detached.
              It’s all{" "}
              <InteractiveFootnote
              ...
              . I remember feeling overwhelmed, and everything just spiralled
              out of control.
            </p>
        ...
        <Section delay={0.6}>
          ...
          >
            <p>
              ...
              stings, drenched in medical solution. I can hardly feel my limbs.
              The smell of hospital floors—bleach and antiseptic—irritates me.
            </p>
            <p>
              I glance at myself: bandages wrap all around my body, laid
              lifelessly on the bed. I try to move but can’t. Maybe I’m too
              feeble. I’ve never been physically strong. Throughout my
              childhood, I rarely went outside. Even in school, I used to slip
        ...
        <Section delay={0.8}>
          ...
          >
            <p>
              ...
              she’s in no hurry. “What’s the problem with these people?” I
              mutter to myself.
            </p>
            <p>
              “How are you feeling now?” she asks, her tone familiar, as if she
              knows me. I have{" "}
              <InteractiveFootnote
              ...
              I’ve been here. Maybe she does, but she keeps inspecting my
              bandages, making me uncomfortable.
            </p>
            <p>
              “A little bit better, I guess,” I reply. She remains neutral and
              just walks away. “Well, that’s awkward,” I say to myself.
            </p>
            <EnhancedMarginNote side="right">
        ...
        <Section delay={1.0}>
          <motion.div
            ...
            className="text-lg leading-relaxed text-gray-800"
          >
            <h3 className="mb-6">Am I wishing for less time...</h3>
            <p>
              The door swings open, and suddenly a flood of people rushes in.
              “Are you alright, my dear? Are you okay? Why would you do such
              things to us? Have you lost your mind? Why won’t you ever think
              of us?” I question myself—Am I wishing for less time?
            </p>
            <p>
              I freeze, overwhelmed. They’re my parents, but I don’t utter a
              single word. They stare at me as if this is a scene from a movie.
              I turn my head awkwardly to the white pillowcase and rest my head
              on it. “He was never like this. What is wrong with him?” I hear
              them complain.
            </p>
            <EnhancedMarginNote side="right">
        ...
        <Section delay={1.2}>
          ...
          >
            ...
            />
            <EnhancedBlockQuote>
              Can I wait until my heart doesn’t swell anymore; in random
