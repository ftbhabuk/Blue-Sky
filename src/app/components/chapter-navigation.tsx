...
const chapters = [
  ...
  { id: 2, title: "White Walls", route: "/chapters/2" },
          ...
          <SheetContent className="bg-white">
            ...
            <div className="mt-8 space-y-4">
              {chapters.map((chapter) => (
                <Link key={chapter.id} href={chapter.route} onClick={() => setIsOpen(false)}>
                  <motion.div
                    className={`p-4 rounded-lg transition-colors ${
                      chapter.id === currentChapter ? "bg-gray-100 text-gray-800" : "hover:bg-gray-50 text-gray-600"
                    }`}
                    whileHover={{ x: 4 }}
                  >
